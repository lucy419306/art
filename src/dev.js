(function () {
  ...
  function render() {
    const parts = ['<h3>DEV · 拍跳转</h3><div class="dev-row"><button type="button" data-act="prev">上一拍</button><button type="button" data-act="next">下一拍</button><button type="button" data-act="mute">静音</button></div><div class="dev-list">'];
