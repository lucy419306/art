...
function create(){
 const win=new BrowserWindow({width:1440,height:900,minWidth:900,minHeight:650,backgroundColor:'#070a0d',title:'最后一次选择',webPreferences:{contextIsolation:true,nodeIntegration:false,sandbox:true}});
